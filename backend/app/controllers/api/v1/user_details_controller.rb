class Api::V1::UserDetailsController < ApplicationController
	...
	def index
		user_details = User_detail.order(created_at: :desc)
	...
	def set_user_detail
		@user_detail = User_detail.find(params[:id])
	end

	def user_detail_params
		params.permit(:user_detail_gender, :user_detail_stature, :user_detail_age, :user_detail_features, 
									:user_detail_image_path, :user_detail_notification_flag)
	end
end
